...
(function (Game) {
    ...
    var MainMenu = /** @class */ (function (_super) {
        ...
        function MainMenu() {
            ...
            _this.noadev.text.yAligned = 60 + 2 + ((Game.IS_TOUCH && !Game.HAS_LINKS_NOADEV) ? -3.5 : (Game.HAS_LINKS ? -6 : -7.5));
...
(function (Game) {
    var LevelText = /** @class */ (function (_super) {
        ...
        function LevelText() {
            ...
            _this.text0.scale = (Game.Level.speedrun ? 0.66 : 0.9);
            ...
            _this.text0.yAligned = Game.Y_BUTTONS_TOP - 2;
            if (Game.IS_TOUCH) {
    ...
    var SpeedrunTimer = /** @class */ (function (_super) {
        ...
        function SpeedrunTimer() {
            ...
            */
            ...
            _this.text.xAligned = 0;
            _this.text.yAligned = Game.Y_ARROWS_GAME_BUTTONS + 8;
            _this.fix();
            return _this;
        }
    ...
    var LevelTimer = /** @class */ (function (_super) {
        ...
        function LevelTimer() {
            ...
            */
            ...
            _this.text.yAlignView = Utils.AnchorAlignment.START;
            _this.text.xAligned = 0;
            _this.text.yAligned = Game.Y_ARROWS_GAME_BUTTONS + (Game.Level.speedrun ? 4 : 6);
            _this.fix();
            return _this;
        }
...
(function (Game) {
    ...
    Game.addAction("configure", function () {
        CreditsDialog.frame = Game.FrameSelector.complex("creditsFrm", Game.Resources.textureBubbles, 14, 317)[0];
    });
